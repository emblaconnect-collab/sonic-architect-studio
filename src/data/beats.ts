...
export const BEATS_CATALOG: Beat[] = [
  {
    ...
    audio: "/audios/cyber-punk-drill.mp3",
    description: "Type Beat Digga D x Nathan x 163Margs — Instrumental pesado com percussão agressiva do UK Drill e synths futuristas.",
    featured: true,
  },
  {
    id: 1,
    ...
    audio: "/audios/streets-talking.mp3",
    description: "Type Beat Pabs x OT7 x Skrilla — Trap energético com hi-hats rápidos e ambiência de rua.",
  },
  {
    id: 2,
    title: "COLD WORLD",
    ...
    audio: "/audios/cold-world.mp3",
    description: "Type Beat NBA YoungBoy x Rod Wave x Polo G — Melodia emotiva com graves profundos e vibe melancólica.",
  },
  {
    id: 3,
    title: "BAILE NIGHTS",
    ...
    audio: "/audios/baile-nights.mp3",
    description: "Type Beat Luh Tyler x Veeze x Scorey — Trap vibrante com sintetizadores cativantes e flow solto.",
  },
  {
    id: 4,
    title: "VELVET SOUL",
    ...
    audio: "/audios/velvet-soul.mp3",
    description: "Type Beat Yung Cracka x TEN x 4KT — Beat agressivo com energia alto nível e cadência pesada.",
  },
];

export const GENRES = ["Todos", "Trap", "Drill"];
